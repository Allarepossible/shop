const PHONES = [
    ...
    ratio : 4,
    nalichie : 'В наличии',
    info : 'СмартфонAlcatel OT4013D PIXI 3 (2 SIM). Смартфон Alcatel One Touch 4013D оснащен четырехдюймовым дисплеем и двумя слотами для SIM-карт...',
    price : '3 990'
}, {
    ...
    render() {
        return (
            <li className="features__item">
                ...
                <div className="features_value">{this.props.value}</div>
            </li>
        );
    }
});
            ...
            <li className="products">
                ...
                <div className="products_center_content">
                    ...
                    <div className="products__reiting">
                        <div className={"reiting__stars stars-" + this.props.ratio}>
                            <ul className="stars">
                        ...
                        <div className="reiting__value">{this.props.ratio}</div>
                    </div>

                </div>
            <div className="products_right_content">
                <div className="products__price">{this.props.price} P</div>
                <div className="products_nallichie">{this.props.nalichie}</div>
